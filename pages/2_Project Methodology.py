...
st.markdown("<br>", unsafe_allow_html=True)
st.image(Base64_Image_utils.get_task_summary_image(),width=900)
st.markdown("<br>", unsafe_allow_html=True)
st.markdown(PAGE_DATA_PREPROCESSING_TEXT, unsafe_allow_html=True)
st.markdown("<br>", unsafe_allow_html=True)
st.markdown(PAGE_REAL_IMAGE_TEXT, unsafe_allow_html=True)
st.markdown("<br>", unsafe_allow_html=True)
st.image(Base64_Image_utils.get_collage_real_image(),width=900)
st.markdown("<br>", unsafe_allow_html=True)
st.markdown(PAGE_DEEPFAKE_IMAGE_TEXT, unsafe_allow_html=True)
st.markdown("<br>", unsafe_allow_html=True)
st.image(Base64_Image_utils.get_collage_deepfake_image(),width=900)
st.markdown("<br>", unsafe_allow_html=True)
...
st.markdown("<br>", unsafe_allow_html=True)
st.image(Base64_Image_utils.get_annotated_confusion_matrix())
